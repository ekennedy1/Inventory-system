...
public class inventoryPopularity extends JFrame {
    static JFrame f;
    Integer itemSize;
        ...
        if(checkDate(date1) && checkDate(date2)){
            try{
                ...
                if((check < 0 || check == 0) && ValidDate1 != null && ValidDate2 != null){
                    ...
                    invFinalStats.entrySet()
                        .stream()
                        .sorted(Map.Entry.comparingByValue(Comparator.reverseOrder()))
                        .forEachOrdered(x-> reverseMap.put(x.getKey(), x.getValue()));
                    

                    Object[][] finalTableResults = new Object[reverseMap.size()][3];
                    ...
                    for(String key : reverseMap.keySet()){
                        ...
                        String FormattedString = String.format("%.4f", reverseMap.get(key));
                    ...
                    f = new JFrame("Inventory Management System : Inventory Popularity");
                    ...
                    String title = "Inventory Popularity from " + date1 + " to " + date2;
    ...
    public static void main(String[] args) {
        ...
        inventoryPopularity iP = new inventoryPopularity();
        iP.init(args[0], args[1]);
    }
