...
public class GUI_Nonsellable extends JFrame {
    static JFrame f;

    public void init() {
        String[] columnNames = { "ITEM ID", "NAME", "EXTENDED PRICE", "QUANTITY", "DELIVERED BY",
        ...
        try {
            ...
            // Find Count of table
            String sqlStatement = "SELECT COUNT(*) FROM nonsellableinventory;";
        ...
        Object[][] inventoryData = new Object[numOfRows][10];
        ...
        try {
            ...
            String sqlStatement = "SELECT * FROM nonsellableinventory;";
            // send statement to DBMS
            ...
            while (result.next()) {
                ...
                inventoryData[i][0] = result.getString("itemid");
                inventoryData[i][1] = result.getString("objectname");
                inventoryData[i][2] = result.getFloat("extendedprice");
                inventoryData[i][3] = result.getInt("quantity");
                inventoryData[i][4] = result.getString("deliveredby");
                inventoryData[i][5] = result.getString("soldby");
                inventoryData[i][6] = result.getFloat("quantitymultiplier");
                inventoryData[i][7] = result.getInt("invoiceline");
                inventoryData[i][8] = result.getString("description");
                inventoryData[i][9] = result.getString("category");
        ...
        // create a new frame
        f = new JFrame("Inventory Management System : Nonsellable Inventory");
        ...
        columnModel.getColumn(8).setPreferredWidth(390);
    ...
    public static void main(String[] args) {
        GUI_Nonsellable nonsellInventory = new GUI_Nonsellable();

        nonsellInventory.init();
    }
